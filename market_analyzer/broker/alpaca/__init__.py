...
if TYPE_CHECKING:
    from market_analyzer.broker.alpaca.account import AlpacaAccount
    from market_analyzer.broker.alpaca.market_data import AlpacaMarketData
    from market_analyzer.broker.alpaca.metrics import AlpacaMetrics
...
def connect_alpaca(
    ...
    3. ``~/.market_analyzer/broker.yaml`` under the ``alpaca`` key
