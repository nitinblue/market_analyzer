"""Zerodha (Kite) market data provider — stub.

Actual API integration pending Kite Connect SDK access.
Zerodha provides REST + WebSocket APIs via Kite Connect for NSE/BSE market data.
"""
...
class ZerodhaMarketData(MarketDataProvider):
    """Zerodha MarketDataProvider for India NSE/BSE.
    ...
    def get_option_chain(
        ...
        raise NotImplementedError("Zerodha option chain not yet implemented")
    ...
    def get_quotes(
        ...
        *,
        ...
        raise NotImplementedError("Zerodha quotes not yet implemented")

    def get_greeks(self, legs: list[LegSpec]) -> dict[str, dict]:
        raise NotImplementedError("Zerodha Greeks not yet implemented")

    def get_intraday_candles(
        self, ticker: str, interval: str = "5m",
    ) -> pd.DataFrame:
        raise NotImplementedError("Zerodha intraday candles not yet implemented")

    def get_underlying_price(self, ticker: str) -> float | None:
        raise NotImplementedError("Zerodha underlying price not yet implemented")
