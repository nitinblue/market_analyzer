"""Zerodha (Kite) watchlist provider — stub.
...
class ZerodhaWatchlist(WatchlistProvider):
    """Zerodha WatchlistProvider for India NSE/BSE.
    ...
    def get_watchlist(self, name: str) -> list[str]:
        raise NotImplementedError("Zerodha watchlist not yet implemented")

    def list_watchlists(self) -> list[str]:
        raise NotImplementedError("Zerodha watchlist listing not yet implemented")

    def create_watchlist(self, name: str, tickers: list[str]) -> bool:
        raise NotImplementedError("Zerodha watchlist creation not yet implemented")
    ...
    def get_all_equities(
        ...
        raise NotImplementedError("Zerodha equity listing not yet implemented")
