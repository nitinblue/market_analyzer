...
class TestSetupImport:
    ...
    def test_all_public_functions_importable(self):
        ...
        from income_desk.cli._setup import (
            run_setup_wizard,
            _setup_free,
            _setup_defaults,
            _setup_ibkr_info,
...
class TestSetupFree:
    def test_setup_free_prints_no_broker_message(self, tmp_path, capsys):
        ...
        from income_desk.cli._setup import _setup_free
...
class TestSetupDefaults:
    def test_creates_settings_yaml_when_absent(self, tmp_path):
        ...
        from income_desk.cli._setup import _setup_defaults
...
class TestSetupIBKRSchwabInfo:
    def test_ibkr_info_prints_steps(self, capsys):
        ...
        from income_desk.cli._setup import _setup_ibkr_info
        _setup_ibkr_info()
        out = capsys.readouterr().out
    ...
    def test_schwab_info_prints_steps(self, capsys):
        ...
        from income_desk.cli._setup import _setup_schwab_info
        _setup_schwab_info()
        out = capsys.readouterr().out
...
class TestSetupZerodha:
    def test_zerodha_saves_env_file(self, tmp_path, monkeypatch):
        ...
        from income_desk.cli._setup import _setup_zerodha
...
class TestSetupTastyTradeYaml:
    def test_tastytrade_saves_yaml(self, tmp_path, monkeypatch):
        ...
        import yaml
        from income_desk.cli._setup import _setup_tastytrade
        ...
        with patch("income_desk.cli._setup._test_tastytrade_connection"):
...
class TestSessionFindsWizardYaml:
    def test_find_config_file_finds_broker_yaml(self, tmp_path, monkeypatch):
        ...
        # Simulate ~/.income_desk/broker.yaml
        ma_dir = tmp_path / ".income_desk"
        ma_dir.mkdir()
...
class TestWizardCLICommand:
    def test_do_wizard_calls_run_setup_wizard(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "income_desk.cli._setup.run_setup_wizard", fake_wizard
        )
...
class TestMainSetupFlag:
    def test_setup_flag_runs_wizard_and_returns(self, monkeypatch):
        ...
        from income_desk.cli import interactive
        # Reload to pick up monkeypatched argv
        with patch("income_desk.cli._setup.run_setup_wizard", fake_wizard):
            with patch("income_desk.cli.interactive.AnalyzerCLI") as mock_cli:
                import importlib
