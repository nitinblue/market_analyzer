...
from income_desk.data.exceptions import CacheError
from income_desk.models.data import CacheMeta, DataType
...
class ParquetCache:
    """Manages parquet files in ~/.income_desk/cache/."""
    ...
    def __init__(self, cache_dir: Path | None = None, staleness_hours: float | None = None) -> None:
        ...
        default_dir = Path.home() / ".income_desk" / "cache"
        legacy_dir = Path.home() / ".income_desk" / "cache"
