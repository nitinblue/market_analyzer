...
if TYPE_CHECKING:
    ...
    from income_desk.models.macro import MacroCalendar, MacroEventImpact
...
def _high_impact_events_on(macro: MacroCalendar, today: date) -> list:
    from income_desk.models.macro import MacroEventImpact
...
def _score_signals(
    ...
    # 3. ORB alignment
    if orb is not None:
        from income_desk.models.technicals import ORBStatus
