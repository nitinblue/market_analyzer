...
_USER_CONFIG_PATH = Path.home() / ".income_desk" / "config.yaml"
_LEGACY_CONFIG_PATH = Path.home() / ".income_desk" / "config.yaml"
...
def load_settings(
    ...
    """Load defaults.yaml, merge ~/.income_desk/config.yaml if present.
