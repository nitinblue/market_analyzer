...
def _build_instruments() -> dict[str, InstrumentInfo]:
    ...
    us_data = [
        ...
        # Mega-cap equities — included in "income" for options (iron condors, spreads)
        ("AAPL", "AAPL", "equity", "tech", ["income", "us_mega", "directional"], "high"),
        ("MSFT", "MSFT", "equity", "tech", ["income", "us_mega", "directional"], "high"),
        ("AMZN", "AMZN", "equity", "tech", ["income", "us_mega", "directional"], "high"),
        ("GOOGL", "GOOGL", "equity", "tech", ["income", "us_mega", "directional"], "high"),
        ("META", "META", "equity", "tech", ["income", "us_mega", "directional"], "high"),
        ("NVDA", "NVDA", "equity", "semiconductor", ["income", "us_mega", "directional"], "high"),
        ("TSLA", "TSLA", "equity", "auto", ["income", "us_mega", "directional"], "high"),
        ("AMD", "AMD", "equity", "semiconductor", ["income", "us_mega", "directional"], "high"),
        ("JPM", "JPM", "equity", "finance", ["income", "us_mega", "directional"], "high"),
        ("BAC", "BAC", "equity", "finance", ["income", "us_mega"], "medium"),
        ("XOM", "XOM", "equity", "energy", ["income", "us_mega", "directional"], "high"),
        ("UNH", "UNH", "equity", "healthcare", ["income", "us_mega"], "medium"),
        ("HD", "HD", "equity", "consumer_disc", ["income", "us_mega"], "medium"),
        ("V", "V", "equity", "finance", ["income", "us_mega"], "medium"),
        ("MA", "MA", "equity", "finance", ["income", "us_mega"], "medium"),
        ("CRM", "CRM", "equity", "tech", ["income", "us_mega"], "medium"),
        ("NFLX", "NFLX", "equity", "communication", ["income", "us_mega", "directional"], "high"),
        # Additional liquid stocks for options income
        ("GS", "GS", "equity", "finance", ["income", "us_mega"], "medium"),
        ("PG", "PG", "equity", "consumer_staple", ["income", "us_mega"], "medium"),
        ("JNJ", "JNJ", "equity", "healthcare", ["income", "us_mega"], "medium"),
        ("CVX", "CVX", "equity", "energy", ["income", "us_mega"], "medium"),
        ("COST", "COST", "equity", "consumer_staple", ["income", "us_mega"], "medium"),
        ("ABBV", "ABBV", "equity", "healthcare", ["income", "us_mega"], "medium"),
    ]
    ...
    india_stocks = [
        ...
        ("RELIANCE", 250, 10, "energy", ["india_fno", "nifty50", "directional"], "medium"),
